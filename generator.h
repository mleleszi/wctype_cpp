...
inline void generate_code(const StagedLookupTable &lookup_table) {
    ...
    // Generate property bit definitions
    {
        ...
        f << R"(// Auto-generated by generate_wctype_table.py
// DO NOT EDIT MANUALLY

#ifndef LLVM_LIBC_SRC_WCTYPE_PROPERTIES_H
#define LLVM_LIBC_SRC_WCTYPE_PROPERTIES_H
...
#endif // LLVM_LIBC_SRC_WCTYPE_PROPERTIES_H
)";
    }
...
static constexpr uint16_t level1[)" << level1.size() << R"(] = {
#include "wctype_level1.inc"
};

// Level 2 table: property bitfields for each character
static constexpr uint16_t level2[)" << level2.size() << R"(] = {
